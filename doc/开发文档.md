...
| **OCR 引擎(备选)** | (无) | — | 轻量级备选方案已移除，当前仅支持 PaddleOCR |
...
```bash
# OCR engine is PaddleOCR by default
...
| 变量 | 默认值 | 描述 |
|------|--------|------|
| `OCR_ENGINE` | `paddleocr` | OCR 引擎: paddleocr |
